...
echo $user_name;
  ...
  $sql = "update  user_login_table set password ='$pass' where user_name='$user_name'";
...
.form-body{
  width: 100%;
  height: 100vh;
  background-image: url(hometour.png);
      ...
      <div class="col-md-6">
        <form action="" class="form_main" method="post">
          ...
          <div class="inputContainer">
            <svg class="inputIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
              viewBox="0 0 16 16">
              <path
            ...
            <input type="text" style="color:white;" class="inputField" id="username" placeholder="Username" name="text1">
          </div>
