...
<?php
 ...
 if(isset($_POST['click']))
 {
  ...
  $insert_query = "insert into feedback_table(name,mobile_no,email_id,feedback) values ('$name','$mobile_no','$email_id','$feedback')";
  if($insert_query)
...
<!-- bg-dark -->
       <header class="text-center">
           <h1 class="display-6 text-center w-100">Feedback</h1>
       </header>
   </div>
