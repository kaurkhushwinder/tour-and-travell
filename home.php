...
<!-- video calling -->
  ...
  <div class="box1 box">
    <video autoplay loop muted plays-inline >
      ...
      <h1>India </h1>.
     <a href="tour.php"> <button style="cursor:pointer;" class="red">Explore</button></a>
...
<!-- <div class="har">
  ...
  <div class="garov">
<div class="har1"><img src="image/last_logo.png.webp" alt="">
<div style=" height:100%;">
<div style="flex-direction:coloum;justify-content:center;align-items:center;background:transparent; color:white;">
<h3 style="margin-top:20%; margin-left:17%;">MALDIVE</h3>
<h4 style="margin-left:15%; font-size:10rem;">50%</h4>
<h2 style=" margin-left:7%; font-size:3.2rem;">Last Minute Offer</h2>
<h4  style=" margin-left:7%; font-size:1.5rem;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer pulvinar sed mauris eget tincidunt. Sed lectus nulla, tempor vel.</h4></div>
</div>
</div>
...
<div style=" height:100%;">
<div style="flex-direction:coloum;justify-content:center;align-items:center;background:transparent; color:white;">
<h3 style="margin-top:20%; margin-left:17%;">BALI</h3>
<h4 style="margin-left:15%; font-size:10rem;">38%</h4>
<h2 style=" margin-left:7%; font-size:3.2rem;">Last Minute Offer</h2>
<h4  style=" margin-left:7%; font-size:1.5rem;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer pulvinar sed mauris eget tincidunt. Sed lectus nulla, tempor vel.</h4></div>
</div>
</div>
...
<!-- popular destinations code -->
  <div class="nac1">
   ...
   <div class="card1"><a href="HillStation Tours.php">
    ...
    <div class="content1">
      <h2 class="harms2">From 40000 </h2>
      <h5 class="harms">HillStation Tours(Nainital) </h5>
...
<!-- footter code -->
 ...
 <div class="footer">
  <div>
    ...
    <div class="copyright">
      Copyright ©<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Preety</a>
      </div>
    </div>
    <div>
